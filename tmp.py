...
if __name__ == '__main__':
    ...
    print ("#000000" + str(rgb("000000")))
    print ("#CD0000" + str(rgb("CD0000")))
    print ("#00CD00" + str(rgb("00CD00")))
    print ("#CDCD00" + str(rgb("CDCD00")))
    print ("#0000CD" + str(rgb("0000CD")))
    print ("#CD00CD" + str(rgb("CD00CD")))
    print ("#00CDCD" + str(rgb("00CDCD")))
    print ("#FAEBD7" + str(rgb("FAEBD7")))
    print ("#404040" + str(rgb("404040")))
    print ("#FF0000" + str(rgb("FF0000")))
    print ("#00FF00" + str(rgb("00FF00")))
    print ("#FFFF00" + str(rgb("FFFF00")))
    print ("#0000FF" + str(rgb("0000FF")))
    print ("#FF00FF" + str(rgb("FF00FF")))
    print ("#00FFFF" + str(rgb("00FFFF")))
    print ("#FFFFFF" + str(rgb("FFFFFF")))
